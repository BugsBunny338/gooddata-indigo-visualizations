...
export function generateTooltipFn(viewByAttribute, type) {
    ...
    return (point) => {
        ...
        if (viewByAttribute) {
            ...
            textData.unshift([
                customEscape(viewByAttribute.name || viewByAttribute.formOf.name),
                customEscape(point.category || point.name)
            ]);
...
export function getChartOptions(
    ...
    const xLabel = config.xLabel || (viewByAttribute ? (viewByAttribute.name || viewByAttribute.formOf.name) : '');
